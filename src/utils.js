...
// if you need to use parseHTML or getDoc server-side, add this line:
// import { DOMParser } from 'deno-dom/mod.ts'
export const fetchHTML = (endpoint, options) => fetch(endpoint, options)
  .then(res => res.text())
export const parseHTML = page => new DOMParser().parseFromString(page, 'text/html')
